...
if flag:
    ...
    path_state_dict = "./30_model_in_gpu_0.pkl"
    torch.save(net_state_dict, path_state_dict)

    # load
    # state_dict_load = torch.load(path_state_dict)  # 如果没有gpu, 这样加载会报错
    state_dict_load = torch.load(path_state_dict, map_location="cpu")  # 在cpu上 device不会打印出来
...
if flag:
    ...
    # save
    net_state_dict = net.state_dict()
    path_state_dict = "./30_model_in_multi_gpu.pkl"
    torch.save(net_state_dict, path_state_dict)
