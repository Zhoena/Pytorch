...
# ================= step 5+/5 断点恢复 =================
path_checkpoint = "./28_checkpoint_4_epoch.pkl"
checkpoint = torch.load(path_checkpoint)

net.load_state_dict(checkpoint['model_state_dict'])  # 更新模型
optimizer.load_state_dict(checkpoint['optimizer_state_dict'])  # 更新优化器
start_epoch = checkpoint['epoch']  # 从那个epoch开始

scheduler.last_epoch = start_epoch  # 更新学习率
...
for epoch in range(start_epoch+1, MAX_EPOCH):
    ...
    if (epoch+1) % checkpoint_interval == 0:
        ...
        path_checkpoint = "./28_CHECKPOINT_{}_epoch.pkl".format(epoch)
